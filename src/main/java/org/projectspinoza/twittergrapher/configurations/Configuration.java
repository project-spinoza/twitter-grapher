...
public class Configuration {
	...
	private int layoutAlgoDistance;
	...
	public void loadConfigurations(ConfigHolder cHolder) {
		...
		this.clusterName = containsKey(cHolder.getElasticSearchCred(), "cluster.name") ?  cHolder.getElasticSearchCred().get("cluster.name").toString() : "elasticsearch";
	...
	public int getLayoutAlgoDistance() {
		return layoutAlgoDistance;
	}
	public void setLayoutAlgoDistance(int layoutAlgoDistance) {
	...
	public String toString() {
		return "Configuration [mysqlHost=" + mysqlHost + ", elasticsearchHost="
				+ elasticsearchHost + ", mongodbHost=" + mongodbHost
				+ ", serverPort=" + serverPort + ", serverhost=" + serverHost
				+ ", nodecentralitythreshHold=" + nodecentralitythreshHold
				+ ", pagerankthreshHold=" + pagerankthreshHold
				+ ", neighborcountThreshHold=" + neighborcountThreshHold
				+ ", edgecolorBy=" + edgecolorBy + ", edgeType=" + edgeType
				+ ", nodeSizeBy=" + nodeSizeBy + ", backColor=" + backColor
				+ ", layoutAlgoName=" + layoutAlgoName
				+ ", layoutAlgoIterations=" + layoutAlgoIterations
				+ ", layoutAlgoDistance=" + layoutAlgoDistance
				+ ", elasticsearchPort=" + elasticsearchPort + ", clusterName="
				+ clusterName + ", elasticsearchIndex=" + elasticsearchIndex
				...
				+ mongodbCollectionName + ", mongodbfieldName="
				+ mongodbFieldName + ", mysqlPort=" + mysqlPort
				+ ", mysqluserName=" + mysqlUserName + ", mysqlpassword="
				+ mysqlUserPassword + ", mysqldatabaseName=" + mysqlDatabaseName
				+ ", mysqltableName=" + mysqlTableName
				+ ", mysqldataColumnName=" + mysqlDataColumnName
